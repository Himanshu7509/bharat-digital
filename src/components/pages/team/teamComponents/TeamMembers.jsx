...
const TeamMembers = () => {
  ...
  const TeamCard = ({ member }) => (
    <div className={`${member.bgColor} rounded-2xl p-6 relative overflow-hidden h-64 flex flex-col justify-end`}>
      
      
      <div className="bg-white rounded-xl p-4 mx-2 mb-2">
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-blue-600 mb-4">TEAM</h1>
        <p className="text-gray-600 text-lg">A company portfolio highlights its services, projects, achievements, and expertise.</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex gap-8">
        ...
        <div className="flex-1">
          ...
          {/* Marketing Team */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Marketing Team</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
