    ...
    return (
      <div className=" bg-white overflow-hidden">
        ...
        <div className="relative left-[950px] top-[490px] z-20">
          <button className="rounded-full border-14 border-[#F0F0F0] bg-gradient-to-r from-[#4F6BF0] to-[#25BAC3] w-[160px] h-[160px] text-white shadow-lg flex items-center justify-center flex-col text-xs font-medium hover:scale-105 transition-transform duration-300">
